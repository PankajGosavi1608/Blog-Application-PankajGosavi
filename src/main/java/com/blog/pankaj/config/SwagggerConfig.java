...
public class SwagggerConfig {
	...
	private ApiInfo getInfo() {
		...
		return new ApiInfo("Blogging Application : BikkadIT-06",
				"This project is developed by Pankaj Gosavi", "1.0", "Terms of Service",
				new Contact("Pankaj", "https://PankajUdayGosavi.com", "pankajudaygosawi@gmail.com"),
